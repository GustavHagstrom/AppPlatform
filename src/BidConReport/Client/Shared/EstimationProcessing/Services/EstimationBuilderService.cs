...
{
    private readonly Dictionary<int, Func<BC_EstimationSheet, EstimationBatch, ISheetItem?, ICollection<Models.ATA>, ISheetItem>> _createSheetItemFunctionMap;
    ...
    private static ISheetItem CreateGroup(BC_EstimationSheet result, EstimationBatch batch, ISheetItem? parent, ICollection<Models.ATA> atas)
    {
        var group = new Group
        {
    ...
    private static ISheetItem CreatePart(BC_EstimationSheet result, EstimationBatch batch, ISheetItem? parent, ICollection<Models.ATA> atas)
    {
        var item = new Part
        {
            Description = result.Description,
    ...
    private ISheetItem CreateLayered(BC_EstimationSheet result, EstimationBatch batch, ISheetItem? parent, ICollection<Models.ATA> atas)
    {
    ...
    private ISheetItem CreateQuantity(BC_EstimationSheet result, EstimationBatch batch, ISheetItem? parent, ICollection<Models.ATA> atas)
    {
    ...
    private ISheetItem CreateLockedStage(BC_EstimationSheet result, EstimationBatch batch, ISheetItem? parent, ICollection<Models.ATA> atas)
    {
    ...
    private ISheetItem CreateText(BC_EstimationSheet result, EstimationBatch batch, ISheetItem? parent, ICollection<Models.ATA> atas)
    {
        var item = new Text
        {
            Description = result.Description,
