...
public class BidconAccessController : ControllerBase
{
    ...
    {
        var result = await _estimationQueryService.GetEstimationBatchAsync(request.EstimationId);
        return Ok(result);
    }
    ...
    {
        var result = await _estimationQueryService.GetEstimationBatchesAsync(request.EstimationIds);
        return Ok(result);
    }
    ...
    {
        var result = await _estimationQueryService.GetEstimationListAsync();
        return Ok(result);
    }
    ...
    {
        var result = await _estimationQueryService.GetFolderBatchAsync();
        return Ok(result);
    }
}
