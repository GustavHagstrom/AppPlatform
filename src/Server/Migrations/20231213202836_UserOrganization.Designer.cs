...
namespace Server.Migrations
{
    ...
    [Migration("20231213202836_UserOrganization")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Enteties.Organization", b =>
                {
                    ...
                    b.Property<string>("BidconCredentialsOrganizationId")
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.HasIndex("BidconCredentialsOrganizationId");
            ...
            modelBuilder.Entity("Server.Enteties.Organization", b =>
                {
                    b.HasOne("Server.Enteties.BidconAccessCredentials", "BidconCredentials")
                        .WithMany()
                        .HasForeignKey("BidconCredentialsOrganizationId");
